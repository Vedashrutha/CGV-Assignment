...
void display_inst()
{
    ...
    char msg_t[]="USER INSTRUCTIONS";
    for(int i=0;i<strlen (msg_t);i++)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg_t[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4, -0.6, 0);
    char msg_n[]="Use Arrow Keys to Rotate the Object in 3D";
    for(int i=0;i<strlen (msg_n);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg_n[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4, 0.6, 0);
    char msg[]="a/x : To Rotate CRANK Clockwise/AntiClockwise";
    for(int i=0;i<strlen(msg);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg[i]);
    glRasterPos3f(-1.4, 0.4, 0);
    char msg1[]="+/- : To Increase/Decrease the Speed by 1 unit";
    for(int i=0;i<strlen(msg1);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg1[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4, 0.2, 0);
    char msg2[]="s : Shading ON/OFF";
    for(int i=0;i<strlen(msg2);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg2[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4, 0, 0);
    char msgname1[]="t : Texture ON/OFF";
    for(int i=0;i<strlen(msgname1);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msgname1[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4,-0.2, 0);
    char msg4[]="o/0 : Transparency/Light";
    for(int i=0;i<strlen(msg4);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg4[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.4, -0.4, 0);
    char msg5[]="Right Click for more Simulation Options";
    ...
    glColor3f(1,0,0);
    glRasterPos3f(1.6, -1.5, 0); char msgq[]="Press esc to quit";
    for(int i=0;i<strlen(msgq);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msgq[i]);
...
void display_main()
{
    ...
    glColor3f(1,1,1);
    glRasterPos3f(-0.9, 1, 0);
    char msg_t[]="A CG&V Mini Project On";
    for(int i=0;i<strlen (msg_t);i++)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg_t[i]);

    glColor3f(0, 0.9960,0.9375);
    glRasterPos3f(-0.85, 0.7, 0);
    char msg_n[]="Steam Engine Simulation";
    for(int i=0;i<strlen (msg_n);i++)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg_n[i]);

    glColor3f(0.99609, 0.98046, 0);
    glRasterPos3f(-2.3, 0.5, 0);
    char msg[]="STEAM ENGINE SIMULATION is a bonafide work carried out in partial fulfillment";
    for(int i=0;i<strlen(msg);i++)
    glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg[i]);
    glRasterPos3f(-1.4, 0.3, 0);
    char msg1[]="for CGV Mini Project during the year 2021-2022";
    for(int i=0;i<strlen(msg1);i++)
    glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg1[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.6, 0.0, 0);
    char msg2[]="Submitted By :";
    for(int i=0;i<strlen(msg2);i++)
    glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg2[i]);
    glColor3f(0, 1, 0);
    glRasterPos3f(-1.4, -0.2, 0);
    char msgname1[]="Vedashrutha D S (1BY19CS178) & Srinivas R (1BY19CS157)";
    for(int i=0;i<strlen(msgname1);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msgname1[i]);

    glColor3f(0, 1, 0.803);
    glRasterPos3f(-1.6,-0.4, 0);
    char msg4[]="Project Guides :";
    for(int i=0;i<strlen(msg4);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg4[i]);
    glColor3f(0, 1, 0);
    glRasterPos3f(-1.4, -0.6, 0);
    char msg5[]="Prof Muneshwara MS,Prof Chethana C,Prof Shankar R";
    for(int i=0;i<strlen(msg5);i++)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg5[i]);
    ...
    glRasterPos3f(-1.6, -1, 0);
    char clg[]="BMS Institute Of Technology & Management";
...
void keyboard(unsigned char key, int x, int y)
{
  ...
  case 13:
      if(screen1==1){
            glutDisplayFunc(display_inst);
            glutPostRedisplay();
      }
      if((screen1==1) && (screen2==1)){
            glutDisplayFunc(display_sim);
            glutPostRedisplay();
      }
      break;
...
int main(int argc, char **argv)
{
  ...
  */
  ...
  glutInitWindowSize(1080, 600);
  glutCreateWindow("Steam Engine Simulation");
